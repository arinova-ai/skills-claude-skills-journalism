...
| `research-toolkit/skills/web-archiving/SKILL.md` | Blocked script URL literals and documentation-only dependency false positive | Presents archive helpers as DevTools-console functions and the self-hosted Compose fetch as a bounded user-run HTTPS step, preserving destinations and behavior without claiming runtime execution. |
